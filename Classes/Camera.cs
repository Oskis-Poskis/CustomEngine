...
namespace Engine.Common
{
    public class Camera
    {
        ...
        public void Input(Vector2 delta)
        {
            ...
            target_direction = new Vector3((float)Math.Cos(MathHelper.DegreesToRadians(theta)) * (float)Math.Cos(MathHelper.DegreesToRadians(phi)),
        ...
        public void Update(float delta)
        {
            ...
            position = Vector3.Lerp(position, target_position, movement_interp_speed * delta);
            direction = Vector3.Lerp(direction, target_direction, camera_interp_speed * delta);
